 ...
 * 
 */
@Generated(value = "com.linkedin.pegasus.generator.PegasusDataTemplateGenerator", comments = "LinkedIn Data Template. Generated from /Users/jianli/workspaces/SocialPlayServer/restli-common/src/main/pegasus/com/linkedin/restli/restspec/SimpleSchema.pdsc.", date = "Wed Jan 14 22:36:03 PST 2015")
public class SimpleSchema
    extends RecordTemplate
{

    private final static SimpleSchema.Fields _fields = new SimpleSchema.Fields();
    ...
    public SimpleSchema(DataMap data) {
        super(data, SCHEMA);
    }
     ...
     * @see Fields#supports
     */
    public SimpleSchema setSupports(StringArray value, SetMode mode) {
     ...
     * @see Fields#supports
     */
    public SimpleSchema setSupports(StringArray value) {
     ...
     * @see Fields#methods
     */
    public SimpleSchema setMethods(RestMethodSchemaArray value, SetMode mode) {
     ...
     * @see Fields#actions
     */
    public SimpleSchema setActions(ActionSchemaArray value, SetMode mode) {
     ...
     * @see Fields#entity
     */
    public SimpleSchema setEntity(EntitySchema value, SetMode mode) {
    ...
    {
        return ((SimpleSchema) super.clone());
    }
    ...
    public SimpleSchema copy()
        throws CloneNotSupportedException
    {
        return ((SimpleSchema) super.copy());
    }
